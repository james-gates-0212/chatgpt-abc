  ...
  return (
    <section className={` ${open ? "w-64" : "w-16"} sidebar`}>
      ...
      <div className="nav__bottom">
        <DarkMode open={open} />
        <div className="nav">
          <a href='https://james-gates-portfolio.vercel.app' rel="noreferrer" target='_blank' className="nav__item">
            <div className="nav__icons">
              <MdOutlineCoffee />
            </div>
        ...
        <div className="nav">
          <a href='https://github.com/james-gates-0212/chatgpt-abc' className="nav__item">
            <div className="nav__icons">
